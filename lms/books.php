...
include_once 'includes/dbh.inc.php';?>
	...
	<script>
        ...
        const ajaxRequest = () => {
            ...
            xhr.onload = function() {
                if(this.status == 200){
                    // could use some more thing here
                ...
                let row = `
                        <li class="list-item">
                            ...
                            <section class="content-preview">
                                ...
                                <span>${list[i].available? '<span class="checkmark"></span> Available' : '<span class="cross"></span> Not Available'} </span>
                                <br>
        ...
        function pagination(pages) {
            ...
            // correct index for previous existing pagination
            firstPage.value = 1;
        ...
        // there's a better way to do this, need more research
